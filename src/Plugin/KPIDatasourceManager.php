...
class KPIDatasourceManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/KPIDatasource', $namespaces, $module_handler, 'Drupal\kpi_analytics\Plugin\KPIDatasourceInterface', 'Drupal\kpi_analytics\Annotation\KPIDatasource');
